...
The secondary data source is a questionnaire administered to individuals who participated in the CITF Databank initiative, primarily on the partner-study side. Respondents will be identified through a call for participation addressed to representatives of the 100 partner studies.

The questionnaire is structured around three domains: (1) participants' professional backgrounds and experiences; (2) studies' missions, purposes, and motivations; and (3) practices, procedures, and relationships. The first domain also serves as a branching mechanism, routing respondents to role-appropriate question blocks in the remaining sections. Questions in the second and third domains correspond to the topic and phase categories established by the email analysis. The questionnaire also collects information pertaining to respondents' gender, institutional affiliation, and role, which correspond with variables structuring the email analysis, therefore enabling comparison across the two data sources at the level of aggregate categories rather than individual identity. A brief pilot with 2–3 respondents will precede full distribution of the questionnaire.
...
The questionnaire is organized around three sequential domains:
...
The questionnaire is developed after initial quantitative findings are available, so that findings from the topic modeling, network analysis, and fast/slow study comparison can directly inform its design. Questions in each domain include open-ended items pursuing the same themes in greater depth.
