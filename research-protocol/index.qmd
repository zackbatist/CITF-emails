...
A smaller, targeted set of follow-up interviews may be conducted with a subset of respondents, particularly those flagged by the fast/slow study comparison and network centrality analysis, to pursue more open-ended lines of inquiry.
...
### Work Package 3: Questionnaire and Interview Analysis
...
**Sequential integration of methods.** The qualitative component is explicitly designed to follow from the quantitative email analysis. The questionnaire and follow-up interview guide are developed after initial findings are available, making the two work packages intellectually as well as temporally ordered.
...
The questionnaire and follow-up interviews are subject to limitations inherent in retrospective accounts: participants' reconstructions of past experiences are shaped by subsequent developments and current perspectives. These limitations are partially addressed by grounding questionnaire and interview questions in specific documents and timelines surfaced by the email analysis.
